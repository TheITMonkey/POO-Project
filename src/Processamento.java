...
public class Processamento {
    ...
    private void gerador(){
        HashMap<String, String> ativRealiza = new HashMap<>();
        Empresa empresa = new Empresa("123123123","Eduardo","ed@ed.pt","aqui","abc",ativRealiza, 0.5f);
        empresas.put(empresa.getNIF(), empresa);
        HashMap<String, String> NIFs = new HashMap<>();
        NIFs.put("1","1");
        NIFs.put("2","2");
        ...
        atividades.put("A","A");
        atividades.put("B","B");
        Individual individual = new Individual("b","b","b","b","b",2,0,NIFs,atividades);
        individuais.put(individual.getNIF(),individual);
        Despesa despesa = new Despesa(0,"c",new Date(),"a","b","c","c",5);
        Despesa despesa2 = new Despesa(1,"d",new Date(),"a","1","d","d",10);
        ...
        despesas.put(despesa2.getNIFEmitente(), despesasAux);
    }
}
